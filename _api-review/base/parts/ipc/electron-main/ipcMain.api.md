## API Report File for "@sussudio/base/parts/ipc/electron-main/ipcMain"
...
// @public (undocumented)
class ValidatedIpcMain implements Event_2.NodeEventEmitter {
...
// @public @deprecated
export const validatedIpcMain: ValidatedIpcMain;
