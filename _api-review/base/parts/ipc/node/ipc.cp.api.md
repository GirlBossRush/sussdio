## API Report File for "@sussudio/base/parts/ipc/node/ipc.cp"
...
export class Client implements IChannelClient, IDisposable {
    ...
    getChannel<T extends IChannel>(channelName: string): T;
    	// (undocumented)
    readonly onDidProcessExit: Event_2<{
        		code: number;
        		signal: string;
        	}>;
    	// (undocumented)
    protected requestEvent<T>(channelName: string, name: string, arg?: any): Event_2<T>;
    	// (undocumented)
...
// @public
export class Server<TContext extends string> extends ChannelServer<TContext> {
