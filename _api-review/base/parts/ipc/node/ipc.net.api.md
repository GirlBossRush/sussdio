## API Report File for "@sussudio/base/parts/ipc/node/ipc.net"
...
// @public (undocumented)
class ChannelClient implements IChannelClient, IDisposable {
...
// @public (undocumented)
class Client_2<TContext = string> extends IPCClient<TContext> {
    	constructor(protocol: Protocol | PersistentProtocol, id: TContext, ipcLogger?: IIPCLogger | null);
    	// (undocumented)
    dispose(): void;
    	// (undocumented)
    static fromSocket<TContext = string>(socket: ISocket, id: TContext): Client_2<TContext>;
    	// (undocumented)
...
// @public (undocumented)
export function connect(port: number, clientId: string): Promise<Client_2>;

// @public (undocumented)
export function connect(namedPipe: string, clientId: string): Promise<Client_2>;
...
// @public (undocumented)
const enum SocketCloseEventType {
    	// (undocumented)
