## API Report File for "@sussudio/base/parts/storage/common/storage"
...
export class InMemoryStorageDatabase implements IStorageDatabase {
    ...
    getItems(): Promise<Map<string, string>>;
    	// (undocumented)
    readonly onDidChangeItemsExternal: Event_2<any>;
    	// (undocumented)
...
export interface IStorage extends IDisposable {
    ...
    readonly items: Map<string, string>;
    	// (undocumented)
    readonly onDidChangeStorage: Event_2<string>;
    	// (undocumented)
...
// @public (undocumented)
class Storage_2 extends Disposable implements IStorage {
