## API Report File for "@sussudio/base/parts/quickinput/browser/quickInputList"
...
// @public (undocumented)
interface IQuickInputWidgetStyles {
    	// (undocumented)
...
export class QuickInputList {
    ...
    matchOnMeta: boolean;
    	// (undocumented)
    onButtonTriggered: Event_2<IQuickPickItemButtonEvent<IQuickPickItem>>;
    	// (undocumented)
    onChangedAllVisibleChecked: Event_2<boolean>;
    	// (undocumented)
    onChangedCheckedCount: Event_2<number>;
    	// (undocumented)
    onChangedCheckedElements: Event_2<IQuickPickItem[]>;
    	// (undocumented)
    onChangedVisibleCount: Event_2<number>;
    	// (undocumented)
    get onDidChangeFocus(): Event_2<(IQuickPickItem | undefined)[]>;
    	// (undocumented)
    get onDidChangeSelection(): Event_2<{
        		items: (IQuickPickItem | undefined)[];
        		event: UIEvent | undefined;
        	}>;
    	// (undocumented)
    onKeyDown: Event_2<StandardKeyboardEvent>;
    	// (undocumented)
    onLeave: Event_2<void>;
    	// (undocumented)
    onSeparatorButtonTriggered: Event_2<IQuickPickSeparatorButtonEvent>;
    	// (undocumented)
    get scrollTop(): number;
    	set scrollTop(scrollTop: number);
    	// (undocumented)
...
// @public (undocumented)
type QuickPickItem = IQuickPickSeparator | IQuickPickItem;
