## API Report File for "@sussudio/base/browser/ui/menu/menu"
...
export class Menu extends ActionBar {
    ...
    static globalStyleSheet: HTMLStyleElement;
    	// (undocumented)
    get onScroll(): Event_2<ScrollEvent>;
    	// (undocumented)
...
// @public (undocumented)
export const MENU_ESCAPED_MNEMONIC_REGEX: RegExp;

// @public (undocumented)
export const MENU_MNEMONIC_REGEX: RegExp;
