## API Report File for "@sussudio/base/browser/ui/breadcrumbs/breadcrumbsWidget"
...
export class BreadcrumbsWidget {
    ...
    layout(dim: dom.Dimension | undefined): void;
    	// (undocumented)
    readonly onDidChangeFocus: Event_2<boolean>;
    	// (undocumented)
    readonly onDidFocusItem: Event_2<IBreadcrumbsItemEvent>;
    	// (undocumented)
    readonly onDidSelectItem: Event_2<IBreadcrumbsItemEvent>;
    	// (undocumented)
