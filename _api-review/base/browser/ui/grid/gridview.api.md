## API Report File for "@sussudio/base/browser/ui/grid/gridview"
...
// @public (undocumented)
class BranchNode implements IView_2<ILayoutContext>, IDisposable {
    	constructor(
    ...
    get absoluteOrthogonalOffset(): number;
    	// (undocumented)
    addChild(node: Node_2, size: number | Sizing, index: number, skipLayout?: boolean): void;
    	// (undocumented)
...
export class GridView implements IDisposable {
    ...
    dispose(): void;
    	...
    	getViewMap(map: Map<IView, HTMLElement>, node?: Node_2): void;
...
// @public
interface IView_2<TLayoutContext = undefined> {
    	readonly element: HTMLElement;
...
// @public (undocumented)
class LeafNode implements IView_2<ILayoutContext>, IDisposable {
    	constructor(
    		view: IView,
    		orientation: Orientation,
    		layoutController: LayoutController,
