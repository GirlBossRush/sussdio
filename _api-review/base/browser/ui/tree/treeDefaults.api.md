## API Report File for "@sussudio/base/browser/ui/tree/treeDefaults"
...
// @public (undocumented)
class AsyncDataTree<TInput, T, TFilterData = void> implements IDisposable, IThemable {
    	constructor(
    		user: string,
    		container: HTMLElement,
    		delegate: IListVirtualDelegate<T>,
...
// @public (undocumented)
interface IAsyncDataTreeOptions<T, TFilterData = void>
...
// @public (undocumented)
interface IAsyncDataTreeUpdateChildrenOptions<T> extends IObjectTreeSetChildrenOptions<T> {}

// @public (undocumented)
interface IAsyncDataTreeViewState {
    	// (undocumented)
