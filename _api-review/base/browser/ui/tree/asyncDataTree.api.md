## API Report File for "@sussudio/base/browser/ui/tree/asyncDataTree"
...
// @public (undocumented)
abstract class AbstractTree<T, TFilterData, TRef> implements IDisposable {
    	constructor(
    		_user: string,
...
// @public (undocumented)
class AbstractTreeViewState implements IAbstractTreeViewState {
...
export class AsyncDataTree<TInput, T, TFilterData = void> implements IDisposable, IThemable {
    ...
    get onDidBlur(): Event_2<void>;
    	// (undocumented)
    get onDidChangeCollapseState(): Event_2<ICollapseStateChangeEvent<IAsyncDataTreeNode<TInput, T> | null, TFilterData>>;
    	// (undocumented)
    get onDidChangeContentHeight(): Event_2<number>;
    	// (undocumented)
    readonly onDidChangeFindMode: Event_2<TreeFindMode>;
    	// (undocumented)
    get onDidChangeFindOpenState(): Event_2<boolean>;
    	// (undocumented)
    get onDidChangeFocus(): Event_2<ITreeEvent<T>>;
    	// (undocumented)
    get onDidChangeModel(): Event_2<void>;
    ...
    get onDidScroll(): Event_2<ScrollEvent>;
    	// (undocumented)
    get onDidUpdateOptions(): Event_2<IAsyncDataTreeOptionsUpdate>;
    	// (undocumented)
    get onKeyDown(): Event_2<KeyboardEvent>;
    	// (undocumented)
    get onMouseClick(): Event_2<ITreeMouseEvent<T>>;
...
// @public (undocumented)
class CompressibleObjectTree<T extends NonNullable<any>, TFilterData = void>
...
// @public (undocumented)
type ElementMapper<T> = (elements: T[]) => T;
...
// @public (undocumented)
interface IAbstractTreeOptions<T, TFilterData = void> extends IAbstractTreeOptionsUpdate, IListOptions<T> {
    	// (undocumented)
...
// @public (undocumented)
interface IAbstractTreeOptionsUpdate extends ITreeRendererOptions {
    	// (undocumented)
...
// @public (undocumented)
interface IAbstractTreeViewState {
    	// (undocumented)
    readonly expanded: {
        		[id: string]: 1 | 0;
        	};
...
// @public (undocumented)
interface IAsyncDataSource<TInput, T> {
    	// (undocumented)
...
// @public (undocumented)
interface ICompressedTreeElement<T> extends ITreeElement<T> {
    	// (undocumented)
...
// @public (undocumented)
interface ICompressedTreeNode<T> {
    	// (undocumented)
    readonly elements: T[];
    	// (undocumented)
    readonly incompressible: boolean;
...
// @public (undocumented)
interface ICompressibleKeyboardNavigationLabelProvider<T> extends IKeyboardNavigationLabelProvider<T> {
    	// (undocumented)
...
// @public (undocumented)
interface ICompressibleObjectTreeModelOptions<T, TFilterData> extends IObjectTreeModelOptions<T, TFilterData> {
    	// (undocumented)
    readonly compressionEnabled?: boolean;
    	// (undocumented)
...
// @public (undocumented)
interface ICompressibleObjectTreeOptions<T, TFilterData = void> extends IObjectTreeOptions<T, TFilterData> {
    	// (undocumented)
    readonly compressionEnabled?: boolean;
    	// (undocumented)
    readonly elementMapper?: ElementMapper<T>;
...
// @public (undocumented)
interface ICompressibleObjectTreeOptionsUpdate extends IAbstractTreeOptionsUpdate {
    	// (undocumented)
    readonly compressionEnabled?: boolean;
}

// @public (undocumented)
interface ICompressibleTreeRenderer<T, TFilterData = void, TTemplateData = void>
...
// @public (undocumented)
interface IObjectTreeOptions<T, TFilterData = void> extends IAbstractTreeOptions<T, TFilterData> {
    	// (undocumented)
    readonly sorter?: ITreeSorter<T>;
}

// @public (undocumented)
interface IObjectTreeSetChildrenOptions<T> {
    	readonly diffDepth?: number;
    	readonly diffIdentityProvider?: IIdentityProvider<T>;
}
...
// @public (undocumented)
class ObjectTree<T extends NonNullable<any>, TFilterData = void> extends AbstractTree<
	T | null,
	TFilterData,
	T | null
> {
