## API Report File for "@sussudio/base/browser/ui/actionbar/actionViewItems"
...
// @public (undocumented)
interface IContentActionHandler {
    	// (undocumented)
...
// @public (undocumented)
interface ISelectBoxDelegate extends IDisposable {
    	// (undocumented)
    applyStyles(): void;
    	// (undocumented)
    blur(): void;
    ...
    focus(): void;
    	// (undocumented)
    readonly onDidSelect: Event_2<ISelectData>;
    	// (undocumented)
    render(container: HTMLElement): void;
    	// (undocumented)
...
// @public (undocumented)
interface ISelectBoxStyles extends IListStyles {
    	// (undocumented)
...
// @public (undocumented)
class SelectBox extends Widget implements ISelectBoxDelegate, IThemable {
    	constructor(
    		options: ISelectOptionItem[],
    		selected: number,
    		contextViewProvider: IContextViewProvider,
    ...
    focus(): void;
    	// (undocumented)
    get onDidSelect(): Event_2<ISelectData>;
    	// (undocumented)
    render(container: HTMLElement): void;
    	// (undocumented)
    select(index: number): void;
