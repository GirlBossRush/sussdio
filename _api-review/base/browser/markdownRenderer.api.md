## API Report File for "@sussudio/base/browser/markdownRenderer"
...
// @public (undocumented)
export const allowedMarkdownAttr: string[];
...
// @public
export function renderMarkdownAsPlaintext(markdown: IMarkdownString): string;

// @public
export function renderStringAsPlaintext(string: IMarkdownString | string): string;
