## API Report File for "@sussudio/base/browser/event"
...
export class DomEmitter<K extends keyof DOMEventMap> implements IDisposable {
    ...
    dispose(): void;
    	// (undocumented)
    get event(): Event_2<DOMEventMap[K]>;
}
...
export interface IDomEvent {
    	// (undocumented)
    <K extends keyof HTMLElementEventMap>(element: EventHandler, type: K, useCapture?: boolean): Event_2<
    		HTMLElementEventMap[K]
    	>;
    	// (undocumented)
    (element: EventHandler, type: string, useCapture?: boolean): Event_2<unknown>;
}
