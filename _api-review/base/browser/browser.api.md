## API Report File for "@sussudio/base/browser/browser"
...
// @public (undocumented)
export const onDidChangeFullscreen: Event_2<void>;

// @public
export const PixelRatio: PixelRatioFacade;

// @public (undocumented)
class PixelRatioFacade {
    	get onDidChange(): Event_2<number>;
    	get value(): number;
}
